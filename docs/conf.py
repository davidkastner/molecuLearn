...
latex_documents = [
    (master_doc, 'ml.tex', 'molecuLearn Documentation',
     'ml', 'manual'),
]
...
man_pages = [
    (master_doc, 'ml', 'molecuLearn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ml', 'molecuLearn Documentation',
     author, 'ml', 'Extract patterns from ab-initio molecular dynamics trajectories using machine learning',
     'Miscellaneous'),
]
